...
/*   Updated: 2019/03/21 16:15:17 by mlurker          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_point		*ft_peresapis(t_field *field, t_list_p *list_p)
{
	...
	int w = field->width;
	int x = 30 * w; // начало отрисовки картинки, будем расчитывать в зависимости от ширины экрана
	int y =  10 * h;
	int w1 = 1;
